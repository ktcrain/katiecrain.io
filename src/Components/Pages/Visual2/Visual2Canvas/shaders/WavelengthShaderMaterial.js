...
const WavelengthShaderMaterial = {
  ...
  fragmentShader: [
    ...
    "float curve = f * sin((vUv.x + uTime));",
    "float lineAShape = smoothstep(1.0 - clamp(distance(curve + vUv.y, 0.5) * 1.0, 0.0, 1.0), 1.0, 0.99);",
    "vec3  lineACol = (1.0 - lineAShape) * vec3(mix(c, black, lineAShape));",
    "c = mix(c, lineACol, 1.0);",
