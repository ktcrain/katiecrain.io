...
const ContactBackgroundShaderMaterial = {
  uniforms: uniforms,
  vertexShader: [
  ...
  fragmentShader: [
    ...
    // {x,y} center of canvas
    "vec2 toCenter = vec2(0.5)-vUv;",
    "float angle = atan(toCenter.y,toCenter.x);",
    "float radius = length(toCenter)*2.0;",
    "float r = normalize(radius);",

    "vec3 color = mix(vec3(1,1,1), black, radius * 0.8);",
...
export default ContactBackgroundShaderMaterial;
